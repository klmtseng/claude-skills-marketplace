...
核心教訓:**單一建造者有盲點**(repr-lab 2026-06);且否證宣稱 ≠ 系統健康(worldcup 2026-07)。
...
- **T3 為真但不適其用**(使用者要求「不只驗真,還要夠好」時跑;**只出建議不擋結案**):目的有沒有被有效達成——例:教材無進度記錄/複習不對準弱點/接觸頻率不均。study-forge 2026-07 教訓:T1+T2 全過的專案,6 條專業建議裡有 2 條落在 T3,原版 VA 結構性抓不到。
